...
import static com.haylion.haylionutil.ConvertUtils.bytes2HexString;
import static com.haylion.haylionutil.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    public static String encryptMD5File2String(String filePath) {
        File file = StringsUtil.isSpace(filePath) ? null : new File(filePath);
