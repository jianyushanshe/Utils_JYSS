...
public class PhoneUtils {
     ...
     * @param content     短信内容
     */
    public static void sendSms(String phoneNumber, String content, Context context) {
     ...
     * @param content     短信内容
     */
    public static void sendSmsSilent(String phoneNumber, String content, Context context) {
        if (StringsUtil.isEmpty(content)) return;
    ...
    public static List<HashMap<String, String>> getAllContactInfo(Context context) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                // 判断contact_id是否为空
                if (!StringsUtil.isEmpty(contact_id)) {//null   ""
