...
public class AppUtils {
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !StringsUtil.isSpace(packageName) && IntentUtils.getLaunchAppIntent(packageName, context) != null;
    }
     ...
     */
    public static void installApp(Activity activity, String filePath, int requestCode, Context context) {
        installApp(activity, FileUtils.getFileByPath(filePath), requestCode, context);
    }
     ...
     * @param requestCode 请求值
     */
    public static void installApp(Activity activity, File file, int requestCode, Context context) {
        if (!FileUtils.isFileExists(file)) return;
        activity.startActivityForResult(IntentUtils.getInstallAppIntent(file, context), requestCode);
    }
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (StringsUtil.isSpace(packageName)) return;
    ...
    public static boolean uninstallAppSilent(Context context, String packageName, boolean isKeepData) {
        if (StringsUtil.isSpace(packageName)) return false;
     ...
     * @param requestCode 请求值
     */
    public static void launchApp(Activity activity, String packageName, int requestCode, Context context) {
        if (StringsUtil.isSpace(packageName)) return;
        activity.startActivityForResult(IntentUtils.getLaunchAppIntent(packageName, context), requestCode);
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (StringsUtil.isSpace(packageName)) return null;
        try {
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (StringsUtil.isSpace(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !StringsUtil.isSpace(packageName) && packageName.equals(ProcessUtils.getForegroundProcessName(context));
    }
